...
export function StudentCopyRequest() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const trackingNumber = `STD-${Math.random().toString(36).substr(2, 9).toUpperCase()}`;
    
    console.log('Generated tracking number:', trackingNumber);
    
    // Store in localStorage for tracking
    const requests = JSON.parse(localStorage.getItem('studentCopyRequests') || '[]');
    const newRequest = {
      id: trackingNumber,
    ...
    localStorage.setItem('studentCopyRequests', JSON.stringify(requests));
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="ml-64 pt-24 pb-12">
        <div className="max-w-6xl mx-auto px-8">
          ...
          {/* Form Card */}
          <Card className="p-8">
            <h1 className="text-3xl mb-8 text-center">Student Copy Request Form</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              {/* Year of Graduation and Number of Copies */}
              ...
              <div>
                ...
                <Input
                  id="reason"
                  placeholder="Please specify the reason for requesting student copies"
