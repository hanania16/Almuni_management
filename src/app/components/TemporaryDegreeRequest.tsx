...
export function TemporaryDegreeRequest() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const trackingNumber = `TMP-${Math.random().toString(36).substr(2, 9).toUpperCase()}`;
    
    console.log('Generated tracking number:', trackingNumber);
    
    // Store in localStorage for tracking
    const requests = JSON.parse(localStorage.getItem('temporaryDegreeRequests') || '[]');
    const newRequest = {
      id: trackingNumber,
      ...
      status: 'Pending',
      type: 'Temporary Degree',
    };
    requests.push(newRequest);
    localStorage.setItem('temporaryDegreeRequests', JSON.stringify(requests));
          ...
          <Card className="p-8">
            <div className="bg-yellow-100 border-l-4 border-yellow-500 p-4 mb-8">
              <p className="text-yellow-900">
                <strong>Note:</strong> Temporary degree certificates are issued while awaiting the original degree. Processing time is typically 5-7 business days.
              </p>
            </div>

            <h1 className="text-3xl mb-8 text-center">Temporary Degree Request Form</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              {/* Reason */}
              <div>
                <Label htmlFor="reason">Reason for Temporary Degree Request *</Label>
                <Textarea
                  id="reason"
                  placeholder="Please explain why you need a temporary degree certificate"
              ...
              {/* File Upload */}
              <div>
                <Label htmlFor="supportingDocument">Supporting Document (if any)</Label>
                <div className="mt-2 flex items-center gap-2">
                  ...
                  <span className="text-sm text-gray-500">
                    {formData.supportingDocument?.name || 'No file chosen'}
                  </span>
                </div>
              </div>
